...
For pairwise alignment, BELLA employs a seed-and-extend alignment algorithm. BELLA's alignment module is based on a dynamic programming $x$-drop implementation proposed by~\Giulia{citation} and implemented in the SeqAn library~\Giulia{citation}, a \CC library for sequence analysis. 
...
The $x$-drop approach~\Giulia{citation} provides a mechanism that limits the band width and provides an appropriate termination condition.
