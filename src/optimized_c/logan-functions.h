		...
		short const &scoreDropOff)
{
	...
	{	
        ...
        //}
		//j++;
		computeAntidiag(a1,a2,a3,offset1,offset2,offset3,direction,antiDiagNo,gapCost,scoringScheme,qseg,tseg,undefined,best,scoreDropOff,cols,rows,maxCol,minCol);
	...
	//printf("%d %d %d\n", (int)antiDiag1.size(), (int)antiDiag2.size(), (int)antiDiag3.size());
	...
	//printf("%d %d %d", longestExtensionCol, longestExtensionRow, longestExtensionScore);
